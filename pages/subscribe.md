...
<form class="contact-form" id="subscribe-form" data-success="subscribe-success" data-email="followorbounce@gmail.com" style="max-width: 520px;">
...
<div class="form-success" id="subscribe-success" style="display:none; max-width:520px;">
